      ...
      <div className="page-body">
        <div className="page-header">
          ...
          <div className="breadcrumbs">
            <Link to="/home">Inicio</Link> <span>/</span> <span>Publicar</span>
          </div>
        </div>
        ...
        <form className="card form" onSubmit={handleSubmit}>
          ...
          <div className="form-row">
            ...
            <textarea value={content} onChange={(e)=>setContent(e.target.value)} rows="6" placeholder="Escribe tu publicación..."></textarea>
          </div>
          ...
          <div className="form-actions">
            ...
            <Link to="/home" className="btn btn-secondary linklike">Cancelar</Link>
          </div>
        </form>
      </div>
    </div>
